...
(function($) {
    ...
    function aweCalendar() {
        $('.awe-calendar').each(function() {
            ...
            aweselect.after('<i class="fa fa-calendar" aria-hidden="true"></i>');
        });
    }
    ...
    function BannerSlider() {
        if($('#banner-slider').length) {
            ...
            $('#banner-slider').owlCarousel({
                ...
                navigationText: ['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-chevron-right" aria-hidden="true"></i>'],
                beforeInit: function () {
