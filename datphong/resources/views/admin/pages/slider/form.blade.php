...
foreach ($languages as $lang) {
    ...
    $elementsInfo[$locale] = [
        [
            ...
            'element' => Form::text("{$locale}[name]", $name, $formInputSlug),
        ],
        [
            'label' => Form::label("{$locale}[description]", 'Mô tả', $formLabelAttr),
            'element' => Form::textarea("{$locale}[description]", $description, $formInputAttr),
        ],
    ];
}
...
$elementsStatus = [
    ...
    [
        'label' => Form::label('thumb', 'Thumb (Dung lượng tối đa: 2048KB)', $formLabelAttr),
