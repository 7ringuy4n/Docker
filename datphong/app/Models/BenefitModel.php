...
class BenefitModel extends AdminModel implements TranslatableContract
{
    use Translatable;

    protected $table = 'benefit';
    protected $translatedAttributes = ['name', 'description'];
    protected $translationForeignKey = 'benefit_model_id';
    protected $folderUpload = 'benefit';
    protected $searchAccepted = ['name'];
    protected $guarded = ['_token', 'thumb_current'];
    protected $translationTable = 'benefit_translations';
    ...
    public function benefit_translations()
    {
        return $this->hasMany(BenefitModelTranslation::class, 'benefit_model_id', 'id')->locale();
    }
}
